...
class RolloutBaseline:
	...
	def _update_baseline(self, model, epoch):
		...
		self.dataset =cvrptw(self.device, size =  self.n_rollout_samples,n_customer=self.n_customer,seed= None,
				   n_depot=self.n_depot, n_car=self.n_car_each_depot, service_window=1000., service_duration=10.,
				   time_factor=100., tw_expansion=3.)
	...
	def eval(self, batch, cost):
		...
		# Combination of baseline cost and enxp. moving average cost
